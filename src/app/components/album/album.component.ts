      ...
      const albums = [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasBodaPapasDavid/rnnchgameubny80u3ytp', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasBodaPapasDavid/jkg62nzelxcjqsa12ls6', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasBodaPapasDavid/v0e95xynw7wkdtjp8o2t', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasBodaPapasDavid/mcnrs9foqbhtfaohgdry', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasBodaPapasDavid/fajcmihjuccltir7met7', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasBodaPapasDavid/fihpue7mnba7v4hyml6r', alt: 'Retrato de una persona' },
          ]
        },
        {
          id: '4',
        ...
        },
        {
          ...
          photos: [
            ...
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/l1tzusy3pwoldstmnqja', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/to6supzcffpt7uaovzkf', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/mbwk28hfj4s1ukg8wo4f', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/vd6mqqstagrib4fqpwht', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/mprxs3lxggk96clf5cq7', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/ox51g34xxvdjole0fjh4', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/fumyqs1dhcd54h40ztuj', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/qyubnglwnkohenqwx1dj', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/mfqrewqxmou9qqpodt3h', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/jammt1wbpdckwjldl0qr', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/v81qcrifmayolijgrvuc', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/t1mzkjtlxobooaasmmm6', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/q0yt9rktjbtxh5pql7rq', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/wcssk7gl4jyyz7jxfdeb', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/puse8ls9qwlwh1jigons', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/haaaekucbvbkz9nn1pue', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/mtceaylavfzrnwkftjyz', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/qzbq09arkbtoxtiyjmkf', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/rjhey9xvnpziaqjnrvzf', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/j4hnqk4ndulpxzrch3a9', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/gd10qrma0zufw56xa7vg', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/h0q5zqdh66377rlywdiu', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/gghfqyvpsb120v1husag', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/xbevdzhpd7acxq1afbya', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/gzrdke3izgbzbfugwwtk', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/iwqysrvunwyhs60iil2v', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/tehzlsvguylxewfgunma', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/tehzlsvguylxewfgunma', alt: 'Retrato de quinceanera' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/xvAniosMalvas/zpmlgiujlm1rzcoh2tio', alt: 'Retrato de quinceanera' },
          ]
        },
        {
          id: '6',
        ...
        },
        {
          ...
          photos: [
            ...
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/gljkbl8atwbouwmbw7fg', alt: 'Retrato de una persona' },
            ...
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/y99b0fvan4pvnmcmbcnn', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/opph6u5ngyxnb1sgx1j9', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/vkshtru8z1vdic92t9gn', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/uj9opaq0uphuwzhzgpkq', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/aq9qt0mvvb6mdm8secxl', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasMariano/tqk5qd7ed6plf5tv4so3', alt: 'Retrato de una persona' },
        ...
        },
        {
          ...
          photos: [
            ...
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/tn6aokfmzpskaoocxgeb', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/n6ahia6dyp24hhj4cobe', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/mwpdofdo9ehloycq1ok5', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/pd2hsqktip0nrixcjcmg', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/zpyvzs3jejmudvwhwwbs', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/krxizbtuybolicfodx2s', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasChristian/rodg5djjidbstutgashz', alt: 'Retrato de una persona' },
            // { url: '', alt: 'Retrato de una persona' },
            // { url: '', alt: 'Retrato de una persona' },
            // { url: '', alt: 'Retrato de una persona' },
            // { url: '', alt: 'Retrato de una persona' },
        ...
        },
        {
          ...
          photos: [
            ...
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/drsgccp12sxx7b8ugkbx', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/mdtsn98varyg9a5rl8ar', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/yoekl3qfxmvo0cgohpyv', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/gzaoxzha88m2nrnvnfiq', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/rqnllbwcmkh9gg1r8svy', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/z1ykx2vuzofhzuwwsjyf', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/gy1qggmmxud3rmtpckqo', alt: 'Retrato de una persona' },
            { url: 'https://res.cloudinary.com/drsyb53ae/image/upload/f_auto,q_auto/v1/fotos-comprimidas/comprimidasGaby/wkcdrccxqyugrfygk1aj', alt: 'Retrato de una persona' },
          ]
        }
      ];
